        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: isDark
                ...
                : const [Color(0xFFEAF4FF), Color(0xFFF8FAFC)],
          ),
        ),
        child: SafeArea(
            ...
            child: Column(
              ...
              children: [
                _HeroCard(
                  ...
                  subtitle: "home_easy_check".tr,
                  icon: Icons.person_add_alt_1_rounded,
                  start: const Color(0xFF2F71DD),
                  end: const Color(0xFF51A4FB),
                ),
                  ...
                  child: Column(
                    children: [
                      ...
                      _ModernField(
                        ...
                        label: "birth_year_optional".tr,
                        helperText: "age_or_birth_hint".tr,
                      ...
                      Obx(
                        () => Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: isDark
                                  ? const Color(0xFF314356)
                                  : const Color(0xFFCADCF3),
                            ),
                          ),
                          child: Row(
                            ...
                            children: [
                              const Icon(
                                ...
                                color: Color(0xFF2F71DD),
                              ),
                              const SizedBox(width: 8),
                              Expanded(
                                child: Text(
                                  "register_group_preview".trParams({
                                    "group": controller.groupLabel(
                                      controller.ageGroup.value,
                                    ),
                                    "limit": controller.dailySugarLimitG.value
                                        .toString(),
                                    "spoons":
                                        (controller.dailySugarLimitG.value / 4)
                                            .toStringAsFixed(1),
                                  }),
                                ),
                              ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: start.withValues(alpha: 0.24),
            blurRadius: 22,
